...
total_timesteps = 1000000  # Example: 100,000 timesteps

# Initialize the callback
callback = TrainingMonitorCallback(n_steps=2048, total_timesteps=total_timesteps, env=carla_env, verbose=1)
